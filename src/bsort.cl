...
__kernel void bsort_init(__global float4 *g_data, __local float4 *l_data) {
   ...
   // if (get_group_id(0) == 0 && get_local_id(0) == (get_local_size(0) - 1)) {
   //    for (int id = 0; id < 2 * get_local_size(0); ++id) {
   //       printf("%f %f %f %f\n", l_data[id].s0, l_data[id].s1, l_data[id].s2, l_data[id].s3);
   //    }
   //    printf("\n");
   // }
   ...
   // if (get_group_id(0) == 0 && get_local_id(0) == (get_local_size(0) - 1)) {
   //    for (int id = 0; id < 2 * get_local_size(0); ++id) {
   //       printf("%f %f %f %f\n", g_data[id].s0, g_data[id].s1, g_data[id].s2, g_data[id].s3);
   //    }
   //    printf("\n");
   // }
